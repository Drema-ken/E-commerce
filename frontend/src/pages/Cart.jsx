          ...
          <div className="flex flex-col md:flex-row justify-between space-x-10 mt-8">
                  ...
                  >
                    ...
                    <div className="flex space-x-12 items-center">
                      ...
                      <div className="flex justify-center border border-gray-500 items-center">
                        <button className=" cursor-pointer text-xl font-bold px-1.5 border-r">
                          -
                        </button>
                        <p className="text-xl px-2">{product.quantity}</p>
                        <button className=" cursor-pointer text-xl px-1 border-l ">
                          +
                        </button>
                      </div>
            ...
            <div className="md:w-1/3 bg-white p-6 rounded-lg shadow-md ">
              ...
              <div className="mb-4 border-b border-gray-400 pb-2">
                ...
                <button className="text-blue-500 hover:underline mt-1 ml-2 cursor-pointer">
                  Change address
                </button>
              </div>
              ...
              <button className="w-full bg-red-600 cursor-pointer rounded-md text-white py-2 hover:bg-red-800">
                Proceed to checkout
              </button>
            </div>
          </div>
